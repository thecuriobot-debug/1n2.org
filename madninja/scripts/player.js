...
export class Player {
  constructor(spawn) {
    ...
    this.baseWalkSpeed = 82;
    this.baseRunSpeed = 122;
    ...
    this.attackChain = [
      { duration: 0.12, w: 18, h: 11, y: 6, damage: 2.2, knockback: 94 },
      { duration: 0.15, w: 24, h: 11, y: 6, damage: 3.1, knockback: 112 },
      { duration: 0.18, w: 30, h: 12, y: 5, damage: 4.8, knockback: 132 },
    ];
